...
class CustomStyle:
    ...
    def INPUT_TYPES(cls):
        ...
        "required": {
            ...
            "style_name":("STRING" , {"tooltip": "The name of the style to be created.",
            ...
            "base_sampler"  :(KSampler.SAMPLERS,  {"tooltip": "The algorithm used when sampling, this can affect the quality, speed and composition of images created with this style.",
                                             }),
            "base_scheduler":(KSampler.SCHEDULERS,{"tooltip": "The scheduler controls how noise is gradually removed to form the image."}),
            ...
            "refi_sampler"  :(KSampler.SAMPLERS,  {"tooltip": "The algorithm used when sampling, this can affect the quality, speed and composition of images created with this style.",
                                             }),
            "refi_scheduler":(KSampler.SCHEDULERS,{"tooltip": "The scheduler controls how noise is gradually removed to form the image."}),
    ...
    def add_custom_style(self,
                         genparams: GenParams, style_name: str = "CUSTOM1",
        ...
        # creates a new set of styles inside which there is only one with the name 'style_name'
        custom_styles = Styles()
        custom_styles.add_style(style_name, style_raw_kv_params)
        # custom_style = Styles(style_name, style_raw_kv_params)

        # update the available styles with the new custom styles
        # (the available styles are found in genparams under the prefix "styles.*")
