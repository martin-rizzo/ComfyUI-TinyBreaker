...
_INFERENCE_MODES = [ "comfyui native", "optimized" ]
_CLIP_TYPES      = [ "sd3", "pixart" ]
...
class LoadT5EncoderExperimental:
    ...
    def load_t5_checkpoint(self, t5_name, type="optimized", inference="sd3", inference_dtype="default"):
        # model_options = {}
        # if device == "cpu":
        #     model_options["load_device"] = model_options["offload_device"] = torch.device("cpu")
        t5_encoder_class = comfy.text_encoders.t5.T5

        # if "optimized" inference is selected,
        # use the custom `T5EncoderModelCmf` class instead of the native one
        if inference == "optimized":
