...
import comfy.utils
import comfy.sample
from .tiles   import get_tile, overlay_tile, multiply_tile, create_tile_mask
...
def refine_latent_image(latent: torch.Tensor,
    ...
    tile = get_tile(latent, tile_pos[0], tile_pos[1], tile_size[0], tile_size[1], dim_order="bchw")
    if add_noise:
